...
Blockly.Msg.MENU_SIM_WRO = "Scena Światowej Olimpiady Robotów";
...
Blockly.Msg.NAO_JOINT_ANKLEPITCH = "kostka - oś pozioma poprzeczna";
Blockly.Msg.NAO_JOINT_ANKLEROLL = "kostka - oś pozioma wzdłużna";
Blockly.Msg.NAO_JOINT_ELBOWROLL = "łokieć - oś pozioma wzdłużna";
Blockly.Msg.NAO_JOINT_ELBOWYAW = "łokieć - oś pionowa";
Blockly.Msg.NAO_JOINT_HAND = "dłoń";
Blockly.Msg.NAO_JOINT_HEADPITCH = "głowa - nachylenie";
Blockly.Msg.NAO_JOINT_HEADYAW = "głowa - rotacja";
Blockly.Msg.NAO_JOINT_HIPPITCH = "biodro - oś pozioma poprzeczna";
Blockly.Msg.NAO_JOINT_HIPROLL = "biodro - oś pozioma wzdłużna";
Blockly.Msg.NAO_JOINT_HIPYAWPITCH = "biodro - oś pionowa";
Blockly.Msg.NAO_JOINT_KNEEPITCH = "kolano - oś pozioma poprzeczna";
Blockly.Msg.NAO_JOINT_SHOULDERPITCH = "ramię - oś pozioma poprzeczna";
Blockly.Msg.NAO_JOINT_SHOULDERROLL = "ramię - oś pozioma wzdłużna";
Blockly.Msg.NAO_JOINT_WRISTYAW = "nadgarstek - oś pionowa";
...
Blockly.Msg.ORA_USER_ACTIVATION_SENT_MAIL_FAIL = "Nie jesteśmy w stanie wysłać do Ciebie e-mail. Skontaktuj się z administratorem serwisu pod adresem »roberta-zentrale@iais.fraunhofer.de«";
...
Blockly.Msg.PROGLIST_SHARE_WITH_GALLERY_TOOLTIP = "Kliknij tutaj aby wysłać swój program do galerii, dzieląc się nim ze wszystkimi innymi użytkownikami.";
...
Blockly.Msg.SERVER_NOT_AVAILABLE = "Open Roberta Lab obecnie nie jest dostępnye</br>Twoje połączenie internetowe zostało zerwane. Jeżeli obecnie masz EV3 podłączony przez USB rozwiąż to za pomocą kliknięcia w środowisko programowania.<br>Jeżeli ten problem nadal występuje prosimy sprawdź swoje połączenie z Internetem i spróbuj odświeżyć (wczytać ponownie) stronę. Jeżeli problem nadal występuje, prosimy, skontaktuj się z nami przez e-mail:</br>roberta-zentrale@iais.fraunhofer.de";
