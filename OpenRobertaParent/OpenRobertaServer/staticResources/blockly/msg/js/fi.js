...
Blockly.Msg.ACTIVITY_TOOLTIP = "Lisätoiminto.";
...
Blockly.Msg.ACTOR_TOOLTIP = "Mikä tahansa toimija";
...
Blockly.Msg.ARDUBRICK_TOOLTIP = "Bot'n Roll -levy, johon on yhdistetty aktuaattoreita ja sensoreita. Myös sisäänrakennettuja aktuaattoreita ja sensoreita on saatavilla, esim. nappeja, näyttö, jne.";
...
Blockly.Msg.BOTH = "molemmat";
Blockly.Msg.BRICKLIGHT = "EV3-yksikön valo";
Blockly.Msg.BRICKLIGHT_BLUE = "sininen";
...
Blockly.Msg.CONFIGURATION_ERROR_MOTORS_ROTATION_DIRECTION = "Vasemman ja oikean moottorin pyörimissuunnat ovat erilaiset!";
Blockly.Msg.CONFIGURATION_ERROR_MOTOR_LEFT_MISSING = "Vasen moottori puuttuu konfiguraatiosta!";
Blockly.Msg.CONFIGURATION_ERROR_MOTOR_LEFT_UNREGULATED = "Vasenta moottoria ei säännellä!";
Blockly.Msg.CONFIGURATION_ERROR_MOTOR_MISSING = "Annetussa portissa ei ole moottoria!";
Blockly.Msg.CONFIGURATION_ERROR_MOTOR_RIGHT_MISSING = "Oikea moottori puuttuu konfiguraatiosta!";
Blockly.Msg.CONFIGURATION_ERROR_MOTOR_RIGHT_UNREGULATED = "Oikeaa moottoria ei säännellä!";
Blockly.Msg.CONFIGURATION_ERROR_MULTIPLE_LEFT_MOTORS = "Konfiguraatiossa on useita vasemmanpuoleisia moottoreita.";
Blockly.Msg.CONFIGURATION_ERROR_MULTIPLE_RIGHT_MOTORS = "Konfiguraatiossa on useita oikeanpuoleisia moottoreita.";
...
Blockly.Msg.CONFIGURATION_ERROR_SENSOR_MISSING = "Sensoria ei ole asetettu porttiin!";
Blockly.Msg.CONFIGURATION_ERROR_SENSOR_WRONG = "Annettuun porttiin on yhdistetty väärä sensori!";
...
Blockly.Msg.CONNECTION_CHECK = "Yhteys robottiin %1 aktiivinen?";
Blockly.Msg.CONNECTION_CHECK_TOOLTIP = "Tarkasta, onko yhteys robottiin aktiivinen.";
...
Blockly.Msg.CONNECTION_FROM_ROBOT = "robotista";
...
Blockly.Msg.CONNECTION_OVER_CHANNEL = "kanava";
Blockly.Msg.CONNECTION_POWER = "with strength";  // untranslated
Blockly.Msg.CONNECTION_PROTOCOL_BLUETOOTH = "Bluetooth";  // untranslated
Blockly.Msg.CONNECTION_RECEIVED_DATA = "vastaanota viesti";
Blockly.Msg.CONNECTION_RECEIVE_TOOLTIP = "Odota viestiä robotilta, johon yritetään ottaa yhteyttä.";
...
Blockly.Msg.CONNECTION_SEND_DATA = "lähetä viesti";
Blockly.Msg.CONNECTION_SEND_TOOLTIP = "Lähetä viesti toiselle robotille.";
...
Blockly.Msg.CONNECTION_START_TOOLTIP = "Yritä yhdistää toiseen robottiin Bluetoothin välityksellä.";
Blockly.Msg.CONNECTION_TOOLTIP = "Robotin yhteys";
Blockly.Msg.CONNECTION_TO_CONNECTION = "yhteyteen";
Blockly.Msg.CONNECTION_TO_ROBOT = "robottiin";
Blockly.Msg.CONNECTION_WAIT_FOR_CONNECTION = "odota yhteyttä";
Blockly.Msg.CONNECTION_WAIT_TOOLTIP = "Odottaa yhteyden muodostumista Bluetoothin välityksellä.";
...
Blockly.Msg.DATATABLE_CONFIGURATIONS = "Konfiguraatiot";
Blockly.Msg.DATATABLE_CONFIGURATION_NAME = "Konfiguraation nimi";
...
Blockly.Msg.DATATABLE_SHARED = "Jaettu";
Blockly.Msg.DATATABLE_SHARED_WITH = "Jaettu";
...
Blockly.Msg.DISPLAY_CLEAR_TOOLTIP = "Tyhjennä näyttö.";
...
Blockly.Msg.DISPLAY_TEXT_TOOLTIP = "Näytä tekstiä ruudulla.";
...
Blockly.Msg.ENCODER_RESET_TOOLTIP = "Alusta moottorienkooderi.";
...
Blockly.Msg.GET = "hae";
Blockly.Msg.GETSAMPLE_TOOLTIP = "Hae valitun sensorin tämänhetkinen lukema.";
...
Blockly.Msg.GYRO_RESET_TOOLTIP = "Alusta gyroskooppisensori.";
Blockly.Msg.GYRO_TOOLTIP = "Gyroskooppisensori";
...
Blockly.Msg.IF_TOOLTIP = "Tarkasta if-osan ehto. Jos ehto on tosi, suorita do-osan toiminto.";
...
Blockly.Msg.INFRARED_TOOLTIP = "Infrapunasensori.";
...
Blockly.Msg.LED_OFF = "LED pois päältä";
Blockly.Msg.LED_OFF_TOOLTIP = "Turns the LED off.";  // untranslated
Blockly.Msg.LED_ON = "LED päälle";
...
Blockly.Msg.MENU_IMPORT_PROG = "vie ohjelma";
Blockly.Msg.MENU_LANGUAGE = "kielet";
Blockly.Msg.MENU_LANGUAGE_TOOLTIP = "kielet";
Blockly.Msg.MENU_LIST = "listaa tallennukset";
Blockly.Msg.MENU_LIST_CONF = "konfiguraationi";
Blockly.Msg.MENU_LIST_PROG = "ohjelmani";
Blockly.Msg.MENU_LIST_PROG_EXAMPLES = "esimerkkiohjelmat";
Blockly.Msg.MENU_LOGGING = "kirjautuminen";
Blockly.Msg.MENU_LOG_IN = "kirjaudu ...";
Blockly.Msg.MENU_LOG_OUT = "kirjaudu ulos";
Blockly.Msg.MENU_MESSAGE_DOWNLOAD = "Ohjelma on ladattu onnistuneesti.";
...
Blockly.Msg.MENU_RIGHT_INFO_TOOLTIP = "Avaa/sulje lisätietoikkuna";
...
Blockly.Msg.MENU_SIM_IMPORT_TOOLTIP = "Lataa oma tausta. Tausta lisätään listan loppuun.";
Blockly.Msg.MENU_SIM_MATH = "matematiikka tausta";
Blockly.Msg.MENU_SIM_POSE_TOOLTIP = "Move the robot back to it's initial position.";  // untranslated
Blockly.Msg.MENU_SIM_RESCUE = "pelastus tausta";
Blockly.Msg.MENU_SIM_ROBERTA = "roberta tausta";
Blockly.Msg.MENU_SIM_ROBOT_TOOLTIP = "open/close the robot's view";  // untranslated
Blockly.Msg.MENU_SIM_SCENE_TOOLTIP = "vaihda tausta";
Blockly.Msg.MENU_SIM_SIMPLE = "yksinkertainen tausta";
Blockly.Msg.MENU_SIM_START_TOOLTIP = "Aloita ohjelma simulaattorissa.";
Blockly.Msg.MENU_SIM_STOP = "Pysäytä";
Blockly.Msg.MENU_SIM_STOP_TOOLTIP = "Pysäytä ohjelma simulaattorissa.";
Blockly.Msg.MENU_SIM_VALUES_TOOLTIP = "avaa/sulje sensorin tietoikkuna";
...
Blockly.Msg.MESSAGE_CONFIGURATION_DELETED = "Konfiguraatio »$« poistettu";
Blockly.Msg.MESSAGE_EDIT_CHECK = "Ohjelma on tarkastettu!";
Blockly.Msg.MESSAGE_EDIT_SAVE_CONFIGURATION = "Konfiguraatio tallennettu";
Blockly.Msg.MESSAGE_EDIT_SAVE_CONFIGURATION_AS = "Konfiguraatio tallennettu nimellä »$«";
Blockly.Msg.MESSAGE_EDIT_SAVE_GROUP_AS = "Your group has been created";  // untranslated
Blockly.Msg.MESSAGE_EDIT_SAVE_PROGRAM = "Ohjelma tallennettu";
Blockly.Msg.MESSAGE_EDIT_SAVE_PROGRAM_AS = "Ohjelma tallennettu nimellä »$«";
...
Blockly.Msg.PLAY_DURATION = "kesto (ms)";
Blockly.Msg.PLAY_EIGHTH = "eighth note";  // untranslated
Blockly.Msg.PLAY_FILE = "tiedosto";
Blockly.Msg.PLAY_FILE_TOOLTIP = "Soita musiikkitiedosto.";
...
Blockly.Msg.PLAY_SETVOLUME_TOOLTIP = "Asettaa äänenvoimakkuuden.";
Blockly.Msg.PLAY_SIXTEENTH = "sixteenth note";  // untranslated
Blockly.Msg.PLAY_TONE = "ääni";
Blockly.Msg.PLAY_TONE_TOOLTIP = "Soita ääni.";
...
Blockly.Msg.POPUP_ABOUT_JOIN = "Haluan auttaa";
...
Blockly.Msg.SENSOR_LIGHTVEML = "visible and UV light sensor";  // untranslated
Blockly.Msg.SENSOR_LIGHTVEML_GETSAMPLE_TOOLTIP = "Gets either visible or UV light dependent on the mode";  // untranslated
...
Blockly.Msg.SOUND_TOOLTIP = "Äänisensori";
Blockly.Msg.START = "aloita";
Blockly.Msg.START_ACTIVITY = "toiminto";
Blockly.Msg.START_ACTIVITY_TOOLTIP = "Aloita toinen toiminto.";
...
Blockly.Msg.TOUR1_DESCRIPTION16 = "Hei ja pidä hauskaa!";
...
Blockly.Msg.ULTRASONIC_TOOLTIP = "Ultraäänisensori";
...
Blockly.Msg.VALIDATION_FIELD_REQUIRED = "Tämä kenttä ei voi olla tyhjä!";
Blockly.Msg.VALIDATION_MAX_LENGTH = "The max. lenght is 25 characters!";  // untranslated
Blockly.Msg.VALIDATION_PASSWORD_MIN_LENGTH = "Salasanan vähimmäispituus on 6 merkkiä!";
Blockly.Msg.VALIDATION_SECOND_PASSWORD_EQUAL = "Salasanojen on täsmättävä!";
Blockly.Msg.VALIDATION_TOKEN_LENGTH = "Kentän pituus on 8 merkkiä!";
Blockly.Msg.VALIDATION_VALID_EMAIL_ADDRESS = "Anna oikea sähköpostiosoite!";
...
Blockly.Msg.WAIT_TIME_TOOLTIP = "Odota aika (ms)";
Blockly.Msg.WAIT_TOOLTIP = "Odota kunnes ehto on tosi.";
