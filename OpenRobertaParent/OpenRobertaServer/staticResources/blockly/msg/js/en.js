...
Blockly.Msg.CONFIGURATION_ERROR_ACTOR_MISSING = "This actuator is not set to the port!";
...
Blockly.Msg.FOURDIGITDISPLAY_SHOW_TOOLTIP = "Displays a number [0-9999] on the Grove 4-Digit Display by Seeed. Position [0-3] represents the starting position of the number. The display has to be connected to the A1 (right) Grove connector.";
...
Blockly.Msg.MOTOR_ON_FOR_TOOLTIP_MS = "Sets servo motor to certain position in degrees.";
...
Blockly.Msg.MOTOR_ON_FOR_TOOLTIP_SERVO = "Turns motor on and stops motor after execution of rotations/degrees.";
...
Blockly.Msg.ON = "on";
Blockly.Msg.ORA_ACCESS_RIGHT_CHANGED = "The shared right is updated!";
Blockly.Msg.ORA_ACCESS_RIGHT_DELETED = "The shared right is deleted!";
...
Blockly.Msg.SENSOR_LIGHTVEML = "visible and UV light sensor";
Blockly.Msg.SENSOR_LIGHTVEML_GETSAMPLE_TOOLTIP = "Gets either visible or UV light dependent on the mode";
...
Blockly.Msg.TEMPERATURE_GETSAMPLE_TOOLTIP = "Gets the current reading from the temperatur in °C sensor.";
